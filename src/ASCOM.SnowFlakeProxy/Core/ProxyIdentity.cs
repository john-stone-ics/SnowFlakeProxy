namespace ASCOM.SnowFlakeProxy
{
    ...
    {
        internal const string VendorProgId = "ASCOM.WandererSnowflakeFilterWheel1.FilterWheel";
        internal const string ProxyProgId = "ASCOM.SnowFlakeProxy.FilterWheel";
        internal const string ProxyName = "Wanderer Snowflake Filter Wheel 1 (Proxy)";
