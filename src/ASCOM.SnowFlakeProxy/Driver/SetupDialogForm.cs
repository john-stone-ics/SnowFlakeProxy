...
namespace ASCOM.SnowFlakeProxy
{
    public class SetupDialogForm : Form
    {
        ...
        internal SetupDialogForm(ProxySettings settings, SnowflakeProxyController controller, ProxySlotIdentity identity)
        {
        ...
        private void InitializeComponent()
        {
            ...
            lbl_prog_id.Text = "Underlying driver: " + identity.vendor_prog_id;
            ...
            Text = identity.proxy_name + " Setup";
            AcceptButton = cmd_ok;
